...
You hold the same license: when an implementer wedges itself on a stalled judgment, a circling argument, or a blocked approval it cannot see past, make the executive call that unblocks it, log it in the state file, and include it in the report.
